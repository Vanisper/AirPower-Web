...
import type { QuerySort } from '../model/QuerySort'
import type { AbstractCurdService, CurdServiceConstructor } from '../service'
import type { ITableHookOption } from './hooks/ITableHookOption'
import type { ITableHookResult } from './hooks/ITableHookResult'
 ...
 * @author Hamm.cn
 */
export function airTableHook<E extends Entity, S extends AbstractCurdService<E>>(
