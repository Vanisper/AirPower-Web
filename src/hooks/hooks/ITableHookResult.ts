...
import type { QueryPage } from '../../model/QueryPage'
import type { QueryRequestPage } from '../../model/QueryRequestPage'
import type { QueryResponsePage } from '../../model/QueryResponsePage'
 ...
 * @author Hamm.cn
 */
export interface ITableHookResult<E extends Entity, S extends AbstractCurdService<E>> {
  /**
   * ### 当前绑定的 `Loading` 状态
